...
# === Track original names for final CSV naming
...
# === Encode Resource Name for embedding
...
# === Normalize numeric features using saved scaler
...
# === Split into inputs: model expects [X_values, embedding_input]
X_embed = X_seq[:, :, 0].astype(int)        # Resource Name embedding column
X_values = X_seq.copy()                     # Full feature tensor
...
print(f"✅ Saved predictions for {len(combined)} generators to prediction_csvs/")
